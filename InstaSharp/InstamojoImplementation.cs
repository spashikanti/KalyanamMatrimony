...
{
    public class InstamojoImplementation : IInstamojo
    {
        private volatile static IInstamojo uniqueInstance; // for singleton design pattern
         ...
         */
        public static IInstamojo getApi(String clientId, String clientSecret, String apiEndpoint, String authEndpoint)
        {
        ...
        public static IInstamojo getApi(String clientId, String clientSecret)
        {
            return getApi(clientId, clientSecret, InstamojoConstants.INSTAMOJO_API_ENDPOINT, InstamojoConstants.INSTAMOJO_AUTH_ENDPOINT);
        }


        private static IInstamojo getInstamojo(String clientId, String clientSecret, String apiEndpoint, String authEndpoint)
        {
